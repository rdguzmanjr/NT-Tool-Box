...
<template>
    ...
    <div v-if="transImages.length==0" id="dropzone" class="flex items-center justify-center h-4/5" @drop.prevent.stop="onDrop" @dragleave.prevent.stop="onDragLeave" @dragover.prevent.stop="onDragOver">
        ...
        <g>
            <path stroke="#ffffff" fill="#ffffff" d="M50.975,20.694c-0.527-9-7.946-16.194-16.891-16.194c-5.43,0-10.688,2.663-13.946,7.008
            ...
            <path stroke="#ffffff" fill="#ffffff"  d="M31.708,30.794c-0.092-0.093-0.203-0.166-0.326-0.217c-0.244-0.101-0.52-0.101-0.764,0
    ...
    <button v-if="transImages.length!=0" class="mb-12 self-center w-32 flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-600 rounded-2xl hover:bg-green-500" @click="handleRefresh">
